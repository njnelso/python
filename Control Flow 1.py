...
# ^^^ Do not worry about this code, we will learn about functions later, but this is is neccessary for your tests to run properly.
  ...
  output_line = ("Your chance of surviving a " + dino + " attack is " + str(chance) + "%")
...
# ^^^ Do not worry about this code, we will learn about functions later, but this is is neccessary for your tests to run properly.
  ...
  if hero_power_level > villain_power_level:
    result = hero + " defeats " + villain + " in battle!"
  ...
  # Otherwise, if hero_power_level is lower than villain_power_level, set the variable named result to "<VILLAIN> defeats <HERO> in battle!"
    ...
    result = villain + " defeats " + hero + " in battle!"
  ...
  # Otherwise, if hero_power_level is the same as villain_power_level, set the variable named result to "<HERO> and <VILLAIN> are evenly matched."
    ...
    result = result = hero + " and " + villain + " are evenly matched." 
